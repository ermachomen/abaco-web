    ...
    <header className="sticky top-0 z-50 border-b border-slate-200 bg-white/95 backdrop-blur">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-8">
        ...
        <nav className="hidden items-center gap-6 md:flex">
          ...
          <a href="tel:+34670607830" className="text-sm font-medium text-slate-600 hover:text-sky-700">670 607 830</a>
          <Link href="/#contacto" className="rounded-xl bg-slate-900 px-4 py-2 text-sm font-semibold text-white hover:bg-slate-800">Contactar</Link>
        </nav>
      </div>
    </header>
  );
