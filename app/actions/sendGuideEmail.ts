...
export async function sendGuideEmail(formData: FormData) {
    ...
    html: `
      <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; color: #0f172a;">
        ...
        <p style="font-size: 14px; line-height: 1.6; color: #475569;">
          ...
          El estudio previo es gratuito y el presupuesto, cerrado.
        </p>
  ...
  // 2) Notificación interna al despacho (si falla no bloqueamos al cliente:
  //    la guía ya se ha enviado, solo se pierde el aviso interno)
  await sendMail({
    to: CONTACT_EMAIL,
    replyTo: email,
