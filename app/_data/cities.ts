...
export const SERVICIOS = {
  ...
  peritaciones: {
    ...
    nombreSeo: "Perito Ingeniero y Peritaciones Judiciales",
    nombreCorto: "Peritaciones",
    descripcionCorta: "Informes periciales de ingeniería para juzgados, abogados y aseguradoras: incendios, accidentes, instalaciones, maquinaria y patologías constructivas.",
    hubPath: "/peritaciones-judiciales",
    pathPrefix: "/peritaciones-",
  },
  tasaciones: {
    nombre: "Tasaciones Técnicas",
    nombreSeo: "Tasaciones Periciales y Valoraciones",
    nombreCorto: "Tasaciones",
    descripcionCorta: "Valoraciones y tasaciones periciales de inmuebles, naves, maquinaria y vehículos para herencias, divorcios, Hacienda y procedimientos judiciales.",
    hubPath: "/tasaciones",
